...
import { a as reactExports, R as React } from './_@astro-renderers_1Hg5a3QD.mjs';
...
const baseUrl = "/memory-journal".replace(/\/$/, "");

export { Block as B, DevLinkProvider as D, Grid as G, HtmlEmbed as H, Image as I, Link as L, NavbarWrapper as N, Paragraph as P, Section as S, Heading as a, baseUrl as b, Span as c, jsxRuntimeExports as j };
