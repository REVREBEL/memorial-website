...
reactExports.forwardRef(function HtmlEmbed2({ tag = "div", className = "", value = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function NavbarWrapper2(props, ref) {
...
export { Block as B, DevLinkProvider as D, Grid as G, Heading as H, Image as I, Link as L, Paragraph as P, Section as S, Span as a, baseUrl as b, jsxRuntimeExports as j };
