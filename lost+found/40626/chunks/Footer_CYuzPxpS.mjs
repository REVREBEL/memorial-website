...
/* empty css                             */
import { a as reactExports, R as React } from './_@astro-renderers_NX0WvgIw.mjs';
...
const useLayoutEffect = isServer ? () => void 0 : reactExports.useLayoutEffect;
function useResizeObserver(ref, fn, options) {
  const [prevWidth, setPrevWidth] = reactExports.useState(ref.current?.clientWidth || 0);
  reactExports.useEffect(() => {
    if (ref.current?.clientWidth) {
      setPrevWidth(ref.current.clientWidth);
    }
  }, [ref]);
  const observer = reactExports.useMemo(() => isServer ? null : new ResizeObserver(([entry]) => {
...
function extractElement(elements, type) {
  ...
  function removeElementByType(_elements) {
    return _elements.map((element) => {
      ...
      const children = removeElementByType(reactExports.Children.toArray(element.props.children));
      return reactExports.cloneElement(element, element.props, ...children);
    });
  }
...
const IXContext = reactExports.createContext({ initEngine: null, restartEngine: null });
const InteractionsProvider = ({ children, createEngine }) => {
  const ixData = reactExports.useRef({});
  const ixStyles = reactExports.useRef();
  const ixEngine = reactExports.useRef();
  const debouncedInit = reactExports.useRef(debounce((data, styles) => {
    if (!ixEngine.current)
  ...
  const initEngine = reactExports.useCallback((data, styles) => {
  ...
  return reactExports.createElement(IXContext.Provider, { value: {
    initEngine,
...
var ji = c((gr, _r) => {
  ...
  var ge;
  typeof self < "u" ? ge = self : typeof window < "u" ? ge = window : typeof global < "u" ? ge = global : typeof _r < "u" ? ge = _r : ge = Function("return this")();
...
var Ir = c((Ge) => {
  ...
  function ki(e, t, r) {
    ...
    return f({ type: Yi.INIT }), n = { dispatch: f, subscribe: p, getState: d, replaceReducer: E }, n[Ki.default] = g, n;
  }
});
var Tr = c((hr) => {
  hr.__esModule = true;
...
var Zi = c((yr) => {
  yr.__esModule = true;
  yr.default = UE;
  var Qi = Ir(), xE = pr(); $i(xE); var GE = Tr(); $i(GE);
  function $i(e) {
    return e && e.__esModule ? e : { default: e };
  }
  function VE(e, t) {
  ...
  function XE(e) {
    Object.keys(e).forEach(function(t) {
      var r = e[t], n = r(void 0, { type: Qi.ActionTypes.INIT });
  ...
  function UE(e) {
    ...
    return function() {
      ...
      if (a) throw a;
      for (var f = false, E = {}, g = 0; g < o.length; g++) {
  ...
  function zE() {
    ...
    return function(n) {
      return function(i, o, u) {
        var a = n(i, o, u), s = a.dispatch, l = [], d = { getState: a.getState, dispatch: function(f) {
          return s(f);
        } };
        return l = t.map(function(p) {
          return p(d);
        }), s = KE.default.apply(void 0, l)(a.dispatch), HE({}, a, { dispatch: s });
      };
    };
  }
});
var Cr = c((U) => {
  ...
  var kE = Ir(), QE = Ie(kE), $E = Zi(), ZE = Ie($E), JE = eo(), e_ = Ie(JE), t_ = to(), r_ = Ie(t_), n_ = Ar(), i_ = Ie(n_), o_ = Tr(); Ie(o_);
  function Ie(e) {
    return e && e.__esModule ? e : { default: e };
  }
...
var ro = c((Rr) => {
  ...
  var a_ = { NAVBAR_OPEN: "NAVBAR_OPEN", NAVBAR_CLOSE: "NAVBAR_CLOSE", TAB_ACTIVE: "TAB_ACTIVE", TAB_INACTIVE: "TAB_INACTIVE", SLIDER_ACTIVE: "SLIDER_ACTIVE", SLIDER_INACTIVE: "SLIDER_INACTIVE", DROPDOWN_OPEN: "DROPDOWN_OPEN", DROPDOWN_CLOSE: "DROPDOWN_CLOSE", MOUSE_CLICK: "MOUSE_CLICK", MOUSE_SECOND_CLICK: "MOUSE_SECOND_CLICK", MOUSE_DOWN: "MOUSE_DOWN", MOUSE_UP: "MOUSE_UP", MOUSE_OVER: "MOUSE_OVER", MOUSE_OUT: "MOUSE_OUT", MOUSE_MOVE: "MOUSE_MOVE", MOUSE_MOVE_IN_VIEWPORT: "MOUSE_MOVE_IN_VIEWPORT", SCROLL_INTO_VIEW: "SCROLL_INTO_VIEW", SCROLL_OUT_OF_VIEW: "SCROLL_OUT_OF_VIEW", SCROLLING_IN_VIEW: "SCROLLING_IN_VIEW", ECOMMERCE_CART_OPEN: "ECOMMERCE_CART_OPEN", ECOMMERCE_CART_CLOSE: "ECOMMERCE_CART_CLOSE", PAGE_START: "PAGE_START", PAGE_FINISH: "PAGE_FINISH", PAGE_SCROLL_UP: "PAGE_SCROLL_UP", PAGE_SCROLL_DOWN: "PAGE_SCROLL_DOWN", PAGE_SCROLL: "PAGE_SCROLL" }, s_ = { ELEMENT: "ELEMENT", CLASS: "CLASS", PAGE: "PAGE" }, c_ = { ELEMENT: "ELEMENT", VIEWPORT: "VIEWPORT" }, l_ = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" }, f_ = { CHILDREN: "CHILDREN", SIBLINGS: "SIBLINGS", IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN" }, d_ = { FADE_EFFECT: "FADE_EFFECT", SLIDE_EFFECT: "SLIDE_EFFECT", GROW_EFFECT: "GROW_EFFECT", SHRINK_EFFECT: "SHRINK_EFFECT", SPIN_EFFECT: "SPIN_EFFECT", FLY_EFFECT: "FLY_EFFECT", POP_EFFECT: "POP_EFFECT", FLIP_EFFECT: "FLIP_EFFECT", JIGGLE_EFFECT: "JIGGLE_EFFECT", PULSE_EFFECT: "PULSE_EFFECT", DROP_EFFECT: "DROP_EFFECT", BLINK_EFFECT: "BLINK_EFFECT", BOUNCE_EFFECT: "BOUNCE_EFFECT", FLIP_LEFT_TO_RIGHT_EFFECT: "FLIP_LEFT_TO_RIGHT_EFFECT", FLIP_RIGHT_TO_LEFT_EFFECT: "FLIP_RIGHT_TO_LEFT_EFFECT", RUBBER_BAND_EFFECT: "RUBBER_BAND_EFFECT", JELLO_EFFECT: "JELLO_EFFECT", GROW_BIG_EFFECT: "GROW_BIG_EFFECT", SHRINK_BIG_EFFECT: "SHRINK_BIG_EFFECT", PLUGIN_LOTTIE_EFFECT: "PLUGIN_LOTTIE_EFFECT" }, p_ = { LEFT: "LEFT", RIGHT: "RIGHT", BOTTOM: "BOTTOM", TOP: "TOP", BOTTOM_LEFT: "BOTTOM_LEFT", BOTTOM_RIGHT: "BOTTOM_RIGHT", TOP_RIGHT: "TOP_RIGHT", TOP_LEFT: "TOP_LEFT", CLOCKWISE: "CLOCKWISE", COUNTER_CLOCKWISE: "COUNTER_CLOCKWISE" };
});
var Nr = c((mr) => {
  ...
  E_(mr, { ActionAppliesTo: function() {
    return g_;
  }, ActionTypeConsts: function() {
    return __;
  } });
  var __ = { TRANSFORM_MOVE: "TRANSFORM_MOVE", TRANSFORM_SCALE: "TRANSFORM_SCALE", TRANSFORM_ROTATE: "TRANSFORM_ROTATE", TRANSFORM_SKEW: "TRANSFORM_SKEW", STYLE_OPACITY: "STYLE_OPACITY", STYLE_SIZE: "STYLE_SIZE", STYLE_FILTER: "STYLE_FILTER", STYLE_FONT_VARIATION: "STYLE_FONT_VARIATION", STYLE_BACKGROUND_COLOR: "STYLE_BACKGROUND_COLOR", STYLE_BORDER: "STYLE_BORDER", STYLE_TEXT_COLOR: "STYLE_TEXT_COLOR", OBJECT_VALUE: "OBJECT_VALUE", PLUGIN_LOTTIE: "PLUGIN_LOTTIE", PLUGIN_SPLINE: "PLUGIN_SPLINE", PLUGIN_RIVE: "PLUGIN_RIVE", PLUGIN_VARIABLE: "PLUGIN_VARIABLE", GENERAL_DISPLAY: "GENERAL_DISPLAY", GENERAL_START_ACTION: "GENERAL_START_ACTION", GENERAL_CONTINUOUS_ACTION: "GENERAL_CONTINUOUS_ACTION", GENERAL_COMBO_CLASS: "GENERAL_COMBO_CLASS", GENERAL_STOP_ACTION: "GENERAL_STOP_ACTION", GENERAL_LOOP: "GENERAL_LOOP", STYLE_BOX_SHADOW: "STYLE_BOX_SHADOW" }, g_ = { ELEMENT: "ELEMENT", ELEMENT_CLASS: "ELEMENT_CLASS", TRIGGER_ELEMENT: "TRIGGER_ELEMENT" };
});
var no = c((Pr) => {
  Object.defineProperty(Pr, "__esModule", { value: true });
  Object.defineProperty(Pr, "InteractionTypeConsts", { enumerable: true, get: function() {
    return I_;
  } });
  var I_ = { MOUSE_CLICK_INTERACTION: "MOUSE_CLICK_INTERACTION", MOUSE_HOVER_INTERACTION: "MOUSE_HOVER_INTERACTION", MOUSE_MOVE_INTERACTION: "MOUSE_MOVE_INTERACTION", SCROLL_INTO_VIEW_INTERACTION: "SCROLL_INTO_VIEW_INTERACTION", SCROLLING_IN_VIEW_INTERACTION: "SCROLLING_IN_VIEW_INTERACTION", MOUSE_MOVE_IN_VIEWPORT_INTERACTION: "MOUSE_MOVE_IN_VIEWPORT_INTERACTION", PAGE_IS_SCROLLING_INTERACTION: "PAGE_IS_SCROLLING_INTERACTION", PAGE_LOAD_INTERACTION: "PAGE_LOAD_INTERACTION", PAGE_SCROLLED_INTERACTION: "PAGE_SCROLLED_INTERACTION", NAVBAR_INTERACTION: "NAVBAR_INTERACTION", DROPDOWN_INTERACTION: "DROPDOWN_INTERACTION", ECOMMERCE_CART_INTERACTION: "ECOMMERCE_CART_INTERACTION", TAB_INTERACTION: "TAB_INTERACTION", SLIDER_INTERACTION: "SLIDER_INTERACTION" };
});
var io = c((br) => {
  Object.defineProperty(br, "__esModule", { value: true });
  Object.defineProperty(br, "ReducedMotionTypes", { enumerable: true, get: function() {
    return R_;
  } });
  var h_ = Nr(), { TRANSFORM_MOVE: T_, TRANSFORM_SCALE: y_, TRANSFORM_ROTATE: O_, TRANSFORM_SKEW: v_, STYLE_SIZE: A_, STYLE_FILTER: S_, STYLE_FONT_VARIATION: C_ } = h_.ActionTypeConsts, R_ = { [T_]: true, [y_]: true, [O_]: true, [v_]: true, [A_]: true, [S_]: true, [C_]: true };
});
var oo = c((Lr) => {
  ...
  m_(Lr, { IX2_ACTION_LIST_PLAYBACK_CHANGED: function() {
    return H_;
...
var G = c((ue) => {
  ...
  $g(ue, { ActionTypeConsts: function() {
  ...
  function at(e, t) {
    return Object.keys(e).forEach(function(r) {
      r !== "default" && !Object.prototype.hasOwnProperty.call(t, r) && Object.defineProperty(t, r, { enumerable: true, get: function() {
        return e[r];
      } });
    }), e;
  }
...
var co = c((Mr) => {
  Object.defineProperty(Mr, "__esModule", { value: true });
  Object.defineProperty(Mr, "ixData", { enumerable: true, get: function() {
    return iI;
  } });
  var rI = G(), { IX2_RAW_DATA_IMPORTED: nI } = rI.IX2EngineActionTypes, iI = (e = Object.freeze({}), t) => {
    switch (t.type) {
      case nI:
...
var he = c((D) => {
  ...
  function V(e, t, r) {
    var n = r;
    n == null && fo(lo);
    for (var i = false, o = arguments.length, u = Array(o > 3 ? o - 3 : 0), a = 3; a < o; a++) u[a - 3] = arguments[a];
    for (var s = 0; s < u.length; s++) {
      ...
      if (l != null) {
        ...
        if (d.length) for (var p = 0; p <= d.length; p++) {
          ...
          if (!(e && n[f] !== void 0)) {
            var E = l[f];
            t && st(n[f]) && st(E) && (E = V(e, t, n[f], E)), !(E === void 0 || E === n[f]) && (i || (i = true, n = ct(n)), n[f] = E);
          }
        }
      }
    }
  ...
  function Ao(e, t, r, n, i, o) {
    ...
    return a.length ? V.call.apply(V, [null, false, false, e, t, r, n, i, o].concat(a)) : V(false, false, e, t, r, n, i, o);
  }
  function So(e, t, r, n, i, o) {
    for (var u = arguments.length, a = Array(u > 6 ? u - 6 : 0), s = 6; s < u; s++) a[s - 6] = arguments[s];
    return a.length ? V.call.apply(V, [null, false, true, e, t, r, n, i, o].concat(a)) : V(false, true, e, t, r, n, i, o);
  }
  function Co(e, t, r, n, i, o, u) {
    var a = lt(e, t);
    a == null && (a = {});
    for (var s = void 0, l = arguments.length, d = Array(l > 7 ? l - 7 : 0), p = 7; p < l; p++) d[p - 7] = arguments[p];
    return d.length ? s = V.call.apply(V, [null, false, false, a, r, n, i, o, u].concat(d)) : s = V(false, false, a, r, n, i, o, u), dt(e, t, s);
  }
  function Ro(e, t) {
    for (var r = Array.isArray(t) ? t : [t], n = false, i = 0; i < r.length; i++) if (uI.call(e, r[i])) {
      n = true;
      break;
    }
    if (!n) return e;
  ...
  function mo(e, t, r, n, i, o) {
    for (var u = arguments.length, a = Array(u > 6 ? u - 6 : 0), s = 6; s < u; s++) a[s - 6] = arguments[s];
    return a.length ? V.call.apply(V, [null, true, false, e, t, r, n, i, o].concat(a)) : V(true, false, e, t, r, n, i, o);
  }
  var aI = { clone: ct, addLast: po, addFirst: Eo, removeLast: _o, removeFirst: go, insert: Io, removeAt: ho, replaceAt: To, getIn: lt, set: ft, setIn: dt, update: Oo, updateIn: vo, merge: Ao, mergeDeep: So, mergeIn: Co, omit: Ro, addDefaults: mo };
  D.default = aI;
});
var Po = c((qr) => {
  Object.defineProperty(qr, "__esModule", { value: true });
  Object.defineProperty(qr, "ixRequest", { enumerable: true, get: function() {
    return _I;
  } });
  var sI = G(), cI = he(), { IX2_PREVIEW_REQUESTED: lI, IX2_PLAYBACK_REQUESTED: fI, IX2_STOP_REQUESTED: dI, IX2_CLEAR_REQUESTED: pI } = sI.IX2EngineActionTypes, EI = { preview: {}, playback: {}, stop: {}, clear: {} }, No = Object.create(null, { [lI]: { value: "preview" }, [fI]: { value: "playback" }, [dI]: { value: "stop" }, [pI]: { value: "clear" } }), _I = (e = EI, t) => {
    if (t.type in No) {
      let r = [No[t.type]];
...
var Lo = c((wr) => {
  ...
  var gI = G(), j = he(), { IX2_SESSION_INITIALIZED: II, IX2_SESSION_STARTED: hI, IX2_TEST_FRAME_RENDERED: TI, IX2_SESSION_STOPPED: yI, IX2_EVENT_LISTENER_ADDED: OI, IX2_EVENT_STATE_CHANGED: vI, IX2_ANIMATION_FRAME_CHANGED: AI, IX2_ACTION_LIST_PLAYBACK_CHANGED: SI, IX2_VIEWPORT_WIDTH_CHANGED: CI, IX2_MEDIA_QUERIES_DEFINED: RI } = gI.IX2EngineActionTypes, bo = { active: false, tick: 0, eventListeners: [], eventState: {}, playbackState: {}, viewportWidth: 0, mediaQueryKey: null, hasBoundaryNodes: false, hasDefinedMediaQueries: false, reducedMotion: false }, mI = 20, NI = (e = bo, t) => {
    switch (t.type) {
      ...
      case RI:
        return (0, j.set)(e, "hasDefinedMediaQueries", true);
      default:
        return e;
    }
  };
...
var xo = c((wq, wo) => {
  ...
  function wI(e) {
    ...
    if (r < 0) return false;
    var n = t.length - 1;
    return r == n ? t.pop() : qI.call(t, r, 1), --this.size, true;
  }
  wo.exports = wI;
});
var Vo = c((xq, Go) => {
...
var Pu = c((aw, Nu) => {
  ...
  function tT() {
    this.size = 0, this.__data__ = { hash: new mu(), map: new (eT || Jh)(), string: new mu() };
  }
  Nu.exports = tT;
});
var Lu = c((sw, bu) => {
...
var Wu = c((_w, Bu) => {
  ...
  function vT(e, t) {
    ...
    if (r instanceof hT) {
      var n = r.__data__;
      if (!TT || n.length < OT - 1) return n.push([e, t]), this.size = ++r.size, this;
...
var Ur = c((vw, ta) => {
  ...
  function BT(e, t, r, n, i, o) {
    ...
    if (a != s && !(u && s > a)) return false;
    var l = o.get(e), d = o.get(t);
    if (l && d) return l == t && d == e;
    var p = -1, f = true, E = r & UT ? new xT() : void 0;
...
var da = c((Rw, fa) => {
  ...
  function ly(e, t, r, n, i, o, u) {
    switch (r) {
      ...
      case oy:
        var s = n & $T;
        if (a || (a = QT), e.size != t.size && !s) return false;
        var l = u.get(e);
        if (l) return l == t;
        n |= ZT, u.set(e, t);
...
var We = c((qw, ma) => {
  var Ca = Sa(), Ny = $(), Ra = Object.prototype, Py = Ra.hasOwnProperty, by = Ra.propertyIsEnumerable, Ly = Ca(/* @__PURE__ */ function() {
    return arguments;
  }()) ? Ca : function(e) {
...
var wa = c((Vw, qa) => {
  ...
  L[aO] = L[sO] = L[cO] = L[lO] = L[fO] = L[dO] = L[pO] = L[EO] = L[_O] = true;
  L[Ky] = L[Yy] = L[oO] = L[zy] = L[uO] = L[ky] = L[Qy] = L[$y] = L[Zy] = L[Jy] = L[eO] = L[tO] = L[rO] = L[nO] = L[iO] = false;
  function gO(e) {
...
var ts = c((kw, es) => {
  ...
  function rv(e, t, r, n, i, o) {
    ...
    if (s != d && !u) return false;
    for (var p = s; p--; ) {
      var f = a[p];
      if (!(u ? f in t : tv.call(t, f))) return false;
    }
    ...
    if (_ && !h) {
      ...
      O != C && "constructor" in e && "constructor" in t && !(typeof O == "function" && O instanceof O && typeof C == "function" && C instanceof C) && (_ = false);
    }
...
var As = c((tx, vs) => {
  ...
  function mv(e, t, r, n, i, o) {
    ...
    return f ? (o || (o = new en()), Av(e, t, r, n, i, o)) : false;
  }
  vs.exports = mv;
});
var tn = c((rx, Rs) => {
  ...
  function Cs(e, t, r, n, i) {
    return e === t ? true : e == null || t == null || !Ss(e) && !Ss(t) ? e !== e && t !== t : Nv(e, t, r, n, Cs, i);
  }
  Rs.exports = Cs;
});
var Ns = c((nx, ms) => {
  ...
  function Mv(e, t, r, n) {
    ...
    for (e = Object(e); i--; ) {
      var a = r[i];
      if (u && a[2] ? a[1] !== e[a[0]] : !(a[0] in e)) return false;
    }
    for (; ++i < o; ) {
      a = r[i];
      ...
      if (u && a[2]) {
        ...
        if (!(f === void 0 ? bv(d, l, Lv | Dv, n, p) : f)) return false;
      }
    }
    return true;
  }
...
var Rt = c((cx, ws) => {
  ...
  function Zv(e, t) {
    if (zv(e)) return false;
    var r = typeof e;
    return r == "number" || r == "symbol" || r == "boolean" || e == null || kv(e) ? true : $v.test(e) || !Qv.test(e) || t != null && e in Object(t);
  }
  ws.exports = Zv;
});
var Vs = c((lx, Gs) => {
...
var Qs = c((Ex, ks) => {
  var js = _e(), sA = un(), cA = w(), lA = ze(), Ks = js ? js.prototype : void 0, Ys = Ks ? Ks.toString : void 0;
  function zs(e) {
...
var Dt = c((dn) => {
  ...
  VS(dn, { ELEMENT_MATCHES: function() {
    return BS;
  ...
  var qc = typeof window < "u", Lt = (e, t) => qc ? e() : t, BS = Lt(() => (0, XS.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], (e) => e in Element.prototype)), WS = Lt(() => {
...
var pn = c((Vx, Uc) => {
  var jS = 4, KS = 1e-3, YS = 1e-7, zS = 10, Qe = 11, Mt = 1 / (Qe - 1), kS = typeof Float32Array == "function";
  function xc(e, t) {
    return 1 - 3 * t + 3 * e;
  }
  function Gc(e, t) {
...
var _n = c((En) => {
  ...
  function P0(e) {
    let t = Z, r = 0, n = 1;
    return e === 0 ? 0 : e === 1 ? 1 : (r || (r = 0.3), t = r / (2 * Math.PI) * Math.asin(1 / n), -(n * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r)));
  }
  function b0(e) {
    let t = Z, r = 0, n = 1;
    return e === 0 ? 0 : e === 1 ? 1 : (r || (r = 0.3), t = r / (2 * Math.PI) * Math.asin(1 / n), n * Math.pow(2, -10 * e) * Math.sin((e - t) * (2 * Math.PI) / r) + 1);
  }
  function L0(e) {
    let t = Z, r = 0, n = 1;
    return e === 0 ? 0 : (e /= 1 / 2) === 2 ? 1 : (r || (r = 0.3 * 1.5), t = r / (2 * Math.PI) * Math.asin(1 / n), e < 1 ? -0.5 * (n * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r)) : n * Math.pow(2, -10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r) * 0.5 + 1);
  }
  function D0(e) {
    let t = Z;
    return (e /= 0.5) < 1 ? 0.5 * (e * e * (((t *= 1.525) + 1) * e - t)) : 0.5 * ((e -= 2) * e * (((t *= 1.525) + 1) * e + t) + 2);
...
var Yc = c((yn) => {
  ...
  W0(yn, { createElementState: function() {
    return Kc;
  }, ixElements: function() {
    return nC;
  ...
  function Kc(e, t, r, n, i) {
    let o = r === H0 ? (0, wt.getIn)(i, ["config", "target", "objectId"]) : null;
...
var zc = c((On) => {
  ...
  }, cC = (e) => e || { value: 0 }, lC = (e) => ({ value: e.value }), fC = (e) => {
    let t = window.Webflow.require("lottie");
    if (!t) return null;
    let r = t.createInstance(e);
    return r.stop(), r.setSubframe(true), r;
  }, dC = (e, t, r) => {
    if (!e) return;
...
var Qc = c((vn) => {
  ...
  var _C = (e) => document.querySelector(`[data-w-id="${e}"]`), gC = () => window.Webflow.require("spline"), IC = (e, t) => e.filter((r) => !t.includes(r)), hC = (e, t) => e.value[t], TC = () => null, kc = Object.freeze({ positionX: 0, positionY: 0, positionZ: 0, rotationX: 0, rotationY: 0, rotationZ: 0, scaleX: 1, scaleY: 1, scaleZ: 1 }), yC = (e, t) => {
...
var $c = c((Cn) => {
  ...
  var An = "--wf-rive-fit", Sn = "--wf-rive-alignment", RC = (e) => document.querySelector(`[data-w-id="${e}"]`), mC = () => window.Webflow.require("rive"), NC = (e, t) => e.value.inputs[t], PC = () => null, bC = (e, t) => {
    if (e) return e;
    let r = {}, { inputs: n = {} } = t.config.value;
    for (let i in n) n[i] == null && (r[i] = 0);
    return r;
  }, LC = (e) => e.value.inputs ?? {}, DC = (e, t) => {
    ...
    function s(l) {
      ...
      function d() {
        ...
        if (p != null) {
          if (l.isPlaying || l.play(u, false), An in a || Sn in a) {
            let f = l.layout, E = a[An] ?? f.fit, g = a[Sn] ?? f.alignment;
            (E !== f.fit || g !== f.alignment) && (l.layout = f.copyWith({ fit: E, alignment: g }));
          }
          for (let f in a) {
...
var mn = c((Rn) => {
  ...
  Object.defineProperty(Rn, "normalizeColor", { enumerable: true, get: function() {
    return qC;
  } });
...
var Jc = c((Nn) => {
  ...
  }, UC = (e) => e.value, BC = () => null, WC = { color: { match: ({ red: e, green: t, blue: r, alpha: n }) => [e, t, r, n].every((i) => i != null), getValue: ({ red: e, green: t, blue: r, alpha: n }) => `rgba(${e}, ${t}, ${r}, ${n})` }, size: { match: ({ size: e }) => e != null, getValue: ({ size: e }, t) => {
    switch (t) {
      case "-":
        return e;
      default:
...
var tl = c((Pn) => {
  ...
  Object.defineProperty(Pn, "pluginMethodMap", { enumerable: true, get: function() {
    return QC;
  } });
  ...
  var QC = /* @__PURE__ */ new Map([[xt.ActionTypeConsts.PLUGIN_LOTTIE, { ...KC }], [xt.ActionTypeConsts.PLUGIN_SPLINE, { ...YC }], [xt.ActionTypeConsts.PLUGIN_RIVE, { ...zC }], [xt.ActionTypeConsts.PLUGIN_VARIABLE, { ...kC }]]);
});
var Ln = c((bn) => {
...
var pl = c((n2, dl) => {
  ...
  function gR(e, t) {
    return function(r, n) {
      ...
      for (var i = r.length, o = t ? i : -1, u = Object(r); (t ? o-- : ++o < i) && n(u[o], o, u) !== false; ) ;
      return r;
    };
  }
  dl.exports = gR;
...
var yl = c((a2, Tl) => {
  ...
  function DR(e, t, r) {
    ...
    if (!n) return -1;
    var i = n - 1;
    return r !== void 0 && (i = PR(r), i = r < 0 ? bR(n + i, 0) : LR(i, n - 1)), mR(e, NR(t, 3), i, true);
  }
  Tl.exports = DR;
});
var vl = c((s2, Ol) => {
...
var Sl = c((Fn) => {
  ...
  Object.defineProperty(Fn, "default", { enumerable: true, get: function() {
    return xR;
  } });
  function Al(e, t) {
  ...
  function wR(e, t) {
    if (Al(e, t)) return true;
    if (typeof e != "object" || e === null || typeof t != "object" || t === null) return false;
    let r = Object.keys(e), n = Object.keys(t);
    if (r.length !== n.length) return false;
    for (let i = 0; i < r.length; i++) if (!Object.hasOwn(t, r[i]) || !Al(e[r[i]], t[r[i]])) return false;
    return true;
  }
  var xR = wR;
});
var Wl = c((Wn) => {
  ...
  GR(Wn, { cleanupHTMLElement: function() {
    return xm;
  ...
  function sm({ events: e, actionLists: t, site: r } = {}) {
    ...
    return i ? o = i.map((u) => u.key) : (i = [], console.warn("IX2 missing mediaQueries in site data")), { ixData: { events: e, actionLists: t, eventTypeMap: n, mediaQueries: i, mediaQueryKeys: o } };
  }
  var cm = (e, t) => e === t;
  ...
  function Nl(e) {
    ...
    if (e != null && t === "object") {
      ...
      return { id: r, objectId: n, selector: i, selectorGuids: o, appliesTo: u, useEventTarget: a };
    }
    return {};
  }
  function Un({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
    if (!i) throw new Error("IX2 missing elementApi");
    let { targets: o } = e;
    if (Array.isArray(o) && o.length > 0) return o.reduce((P, b) => P.concat(Un({ config: { target: b }, event: t, eventTarget: r, elementRoot: n, elementApi: i })), []);
    ...
    let T = (t?.action?.config?.affectedElements ?? {})[_ || I] || {}, S = !!(T.id || T.selector), v, R, m, N = t && a(Nl(t.target));
    if (S ? (v = T.limitAffectedElements, R = N, m = a(T)) : R = m = a({ id: _, selector: I, selectorGuids: y }), t && O) {
      let P = r && (m || O === true) ? [r] : s(N);
      if (m) {
  ...
  function Em(e, t = {}, r = {}, n, i) {
    ...
    switch (n.actionTypeId) {
      ...
      case Le: {
        ...
        return n.config.widthUnit === ie ? l = Pl.test(a) ? parseFloat(a) : parseFloat(r.width) : l = (0, ne.default)(parseFloat(a), parseFloat(r.width)), n.config.heightUnit === ie ? d = Pl.test(s) ? parseFloat(s) : parseFloat(r.height) : d = (0, ne.default)(parseFloat(s), parseFloat(r.height)), { widthValue: l, heightValue: d };
      }
      case De:
      case Me:
      case Fe:
        return Mm({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: o });
      case Wt:
    ...
    switch (t.actionTypeId) {
      ...
      case Fe: {
        ...
        if (a && a.startsWith("--")) {
          ...
          return { rValue: d.red, gValue: d.green, bValue: d.blue, aValue: d.alpha };
        }
  ...
  var Bn = { [Ne]: Object.freeze({ xValue: 0, yValue: 0, zValue: 0 }), [Pe]: Object.freeze({ xValue: 1, yValue: 1, zValue: 1 }), [be]: Object.freeze({ xValue: 0, yValue: 0, zValue: 0 }), [et]: Object.freeze({ xValue: 0, yValue: 0 }) }, Om = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 }), vm = Object.freeze({ wght: 0, opsz: 0, wdth: 0, slnt: 0 }), Am = (e, t) => {
  ...
  function Rm(e, t, r, n) {
    let i = (0, xn.default)(t, (u, a, s) => `${u} ${s}(${a}${Am(s, r)})`, ""), { setStyle: o } = n;
    fe(e, $e, n), o(e, $e, i);
  }
  function mm(e, t, r, n) {
    let i = (0, xn.default)(t, (u, a, s) => (u.push(`"${s}" ${a}`), u), []).join(", "), { setStyle: o } = n;
    fe(e, Ze, n), o(e, Ze, i);
  }
  function Nm({ actionTypeId: e }, { xValue: t, yValue: r, zValue: n }) {
    return e === Ne && n !== void 0 || e === Pe && n !== void 0 || e === be && (t !== void 0 || r !== void 0);
  }
  var Pm = "\\(([^)]+)\\)", bm = /^rgb/, Lm = RegExp(`rgba?${Pm}`);
  function Dm(e, t) {
    let r = e.exec(t);
    return r ? r[1] : "";
  }
  function Mm({ element: e, actionTypeId: t, computedStyle: r, getStyle: n }) {
    ...
    return { rValue: (0, ne.default)(parseInt(a[0], 10), 255), gValue: (0, ne.default)(parseInt(a[1], 10), 255), bValue: (0, ne.default)(parseInt(a[2], 10), 255), aValue: (0, ne.default)(parseFloat(a[3]), 1) };
  }
  function Fm(e, t, r, n, i, o) {
    ...
    switch (n.actionTypeId) {
      ...
      case Fe: {
        ...
        fe(e, a, o), u(e, a, p >= 1 ? `rgb(${s},${l},${d})` : `rgba(${s},${l},${d},${p})`);
        break;
      }
      default: {
        let { unit: a = "" } = n.config;
  ...
  function Ll({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((i) => {
      ...
      (0, k.isPluginType)(o) ? a = (s) => (0, k.clearPlugin)(o)(s, i) : a = Ul({ effect: Gm, actionTypeId: o, elementApi: r }), Un({ config: u, event: t, elementApi: r }).forEach(a);
    });
  }
  function xm(e, t, r) {
  ...
  var Ul = ({ effect: e, actionTypeId: t, elementApi: r }) => (n) => {
    switch (t) {
      case Ne:
      case Pe:
      case be:
  ...
  function Xm({ actionList: e, actionItemId: t, rawData: r }) {
    let { actionItemGroups: n, continuousParameterGroups: i } = e, o = [], u = (a) => (o.push((0, Cl.mergeIn)(a, ["config"], { delay: 0, duration: 0 })), a.id === t);
    return n && n.some(({ actionItems: a }) => a.some(u)), i && i.some((a) => {
      let { continuousActionGroups: s } = a;
      return s.some(({ actionItems: l }) => l.some(u));
    }), (0, Cl.setIn)(r, ["actionLists"], { [e.id]: { id: e.id, actionItemGroups: [{ actionItems: o }] } });
  }
...
var de = c((Hn) => {
  ...
  Km(Hn, { IX2BrowserSupport: function() {
    return Ym;
...
var zl = c((Kn) => {
  ...
  Object.defineProperty(Kn, "ixInstances", { enumerable: true, get: function() {
    return fN;
  } });
  var jl = G(), Kl = de(), we = he(), { IX2_RAW_DATA_IMPORTED: Jm, IX2_SESSION_STOPPED: eN, IX2_INSTANCE_ADDED: tN, IX2_INSTANCE_STARTED: rN, IX2_INSTANCE_REMOVED: nN, IX2_ANIMATION_FRAME_CHANGED: iN } = jl.IX2EngineActionTypes, { optimizeFloat: Ht, applyEasing: Yl, createBezierEasing: oN } = Kl.IX2EasingUtils, { RENDER_GENERAL: uN } = jl.IX2EngineConstants, { getItemConfigByKey: jn, getRenderType: aN, getStyleProp: sN } = Kl.IX2VanillaUtils, cN = (e, t) => {
    ...
    p != null && (h = p), I = f ?? I, u === uN ? h = 0 : (o || g) && (h = I = 0);
    let { now: y } = t.payload;
    if (r && n) {
      let A = y - (i + I);
      if (a) {
      ...
      return d.length && (S = d.reduce((v, R) => {
        ...
        return v[R] = b, v;
      }, {})), T.current = S, T.position = O, O === 1 && (T.active = false, T.complete = true), (0, we.merge)(e, T);
    }
    return e;
    ...
    switch (t.type) {
      ...
      case tN: {
        ...
        return (0, we.set)(e, r, { id: r, elementId: n, active: false, position: 0, start: 0, origin: p, destination: f, destinationKeys: P, immediate: E, verbose: g, current: null, actionItem: i, actionTypeId: R, eventId: o, eventTarget: u, eventStateKey: a, actionListId: s, groupIndex: l, renderType: m, isCarrier: d, styleProp: N, continuous: _, parameterId: h, actionGroups: I, smoothing: y, restingValue: A, pluginInstance: O, pluginDuration: C, instanceDelay: T, skipMotion: S, skipToValue: v, customEasingFn: Array.isArray(b) && b.length === 4 ? oN(b) : void 0 });
      }
      case rN: {
        let { instanceId: r, time: n } = t.payload;
        return (0, we.mergeIn)(e, [r], { active: true, complete: false, start: n });
      }
      case nN: {
...
var kl = c((Yn) => {
  Object.defineProperty(Yn, "__esModule", { value: true });
  Object.defineProperty(Yn, "ixParameters", { enumerable: true, get: function() {
    return gN;
  } });
  var dN = G(), { IX2_RAW_DATA_IMPORTED: pN, IX2_SESSION_STOPPED: EN, IX2_PARAMETER_CHANGED: _N } = dN.IX2EngineActionTypes, gN = (e = {}, t) => {
    switch (t.type) {
      case pN:
...
var Ql = c((zn) => {
  ...
  Object.defineProperty(zn, "default", { enumerable: true, get: function() {
    return CN;
  } });
  var IN = Cr(), hN = co(), TN = Po(), yN = Lo(), ON = de(), vN = zl(), AN = kl(), { ixElements: SN } = ON.IX2ElementsReducer, CN = (0, IN.combineReducers)({ ixData: hN.ixData, ixRequest: TN.ixRequest, ixSession: yN.ixSession, ixElements: SN, ixInstances: vN.ixInstances, ixParameters: AN.ixParameters });
});
var Zl = c((_2, $l) => {
...
var df = c((h2, ff) => {
  var of = "\\ud800-\\udfff", BN = "\\u0300-\\u036f", WN = "\\ufe20-\\ufe2f", HN = "\\u20d0-\\u20ff", jN = BN + WN + HN, KN = "\\ufe0e\\ufe0f", YN = "[" + of + "]", kn = "[" + jN + "]", Qn = "\\ud83c[\\udffb-\\udfff]", zN = "(?:" + kn + "|" + Qn + ")", uf = "[^" + of + "]", af = "(?:\\ud83c[\\udde6-\\uddff]){2}", sf = "[\\ud800-\\udbff][\\udc00-\\udfff]", kN = "\\u200d", cf = zN + "?", lf = "[" + KN + "]?", QN = "(?:" + kN + "(?:" + [uf, af, sf].join("|") + ")" + lf + cf + ")*", $N = lf + cf + QN, ZN = "(?:" + [uf + kn + "?", kn, af, sf, YN].join("|") + ")", nf = RegExp(Qn + "(?=" + Qn + ")|" + ZN + $N, "g");
  function JN(e) {
...
var Zn = c((A2, Of) => {
  var yf = $n();
  function gP(e, t, r) {
    t == "__proto__" && yf ? yf(e, t, { configurable: true, enumerable: true, value: r, writable: true }) : e[t] = r;
  }
  Of.exports = gP;
});
var Af = c((S2, vf) => {
...
var Hf = c((F2, Wf) => {
  ...
  function Tb(e) {
    ...
    for (var r in e) if (hb.call(e, r)) return false;
    return true;
  }
  Wf.exports = Tb;
});
...
var nd = c((X2, rd) => {
  ...
  function Gb(e, t, r) {
    var n, i, o, u, a, s, l = 0, d = false, p = false, f = true;
...
var od = c((U2, id) => {
  ...
  function Bb(e, t, r) {
    ...
    return Xb(r) && (n = "leading" in r ? !!r.leading : n, i = "trailing" in r ? !!r.trailing : i), Vb(e, t, { leading: n, maxWait: t, trailing: i });
  }
  id.exports = Bb;
});
var jt = c((ei) => {
  ...
  Wb(ei, { actionListPlaybackChanged: function() {
    return PL;
  ...
  var ud = G(), Hb = de(), { IX2_RAW_DATA_IMPORTED: jb, IX2_SESSION_INITIALIZED: Kb, IX2_SESSION_STARTED: Yb, IX2_SESSION_STOPPED: zb, IX2_PREVIEW_REQUESTED: kb, IX2_PLAYBACK_REQUESTED: Qb, IX2_STOP_REQUESTED: $b, IX2_CLEAR_REQUESTED: Zb, IX2_EVENT_LISTENER_ADDED: Jb, IX2_TEST_FRAME_RENDERED: eL, IX2_EVENT_STATE_CHANGED: tL, IX2_ANIMATION_FRAME_CHANGED: rL, IX2_PARAMETER_CHANGED: nL, IX2_INSTANCE_ADDED: iL, IX2_INSTANCE_STARTED: oL, IX2_INSTANCE_REMOVED: uL, IX2_ELEMENT_STATE_CHANGED: aL, IX2_ACTION_LIST_PLAYBACK_CHANGED: sL, IX2_VIEWPORT_WIDTH_CHANGED: cL, IX2_MEDIA_QUERIES_DEFINED: lL } = ud.IX2EngineActionTypes, { reifyState: fL } = Hb.IX2VanillaUtils, dL = (e) => ({ type: jb, payload: { ...fL(e) } }), pL = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: Kb, payload: { hasBoundaryNodes: e, reducedMotion: t } }), EL = () => ({ type: Yb }), _L = () => ({ type: zb }), gL = ({ rawData: e, defer: t }) => ({ type: kb, payload: { defer: t, rawData: e } }), IL = ({ actionTypeId: e = ud.ActionTypeConsts.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: u, verbose: a, rawData: s }) => ({ type: Qb, payload: { actionTypeId: e, actionListId: t, actionItemId: r, testManual: u, eventId: n, allowEvents: i, immediate: o, verbose: a, rawData: s } }), hL = (e) => ({ type: $b, payload: { actionListId: e } }), TL = () => ({ type: Zb }), yL = (e, t) => ({ type: Jb, payload: { target: e, listenerParams: t } }), OL = (e = 1) => ({ type: eL, payload: { step: e } }), vL = (e, t) => ({ type: tL, payload: { stateKey: e, newState: t } }), AL = (e, t) => ({ type: rL, payload: { now: e, parameters: t } }), SL = (e, t) => ({ type: nL, payload: { key: e, value: t } }), CL = (e) => ({ type: iL, payload: { ...e } }), RL = (e, t) => ({ type: oL, payload: { instanceId: e, time: t } }), mL = (e) => ({ type: uL, payload: { instanceId: e } }), NL = (e, t, r, n) => ({ type: aL, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } }), PL = ({ actionListId: e, isPlaying: t }) => ({ type: sL, payload: { actionListId: e, isPlaying: t } }), bL = ({ width: e, mediaQueries: t }) => ({ type: cL, payload: { width: e, mediaQueries: t } }), LL = () => ({ type: lL });
});
var cd = c((ri) => {
  ...
  DL(ri, { elementContains: function() {
    return HL;
...
var ni = c((H2, fd) => {
  var QL = K(), ld = Object.create, $L = /* @__PURE__ */ function() {
    function e() {
    }
    return function(t) {
      if (!QL(t)) return {};
...
var Dd = c((J2, Ld) => {
  var dD = Pd(), bd = $n(), pD = Pt(), ED = bd ? function(e, t) {
    return bd(e, "toString", { configurable: true, enumerable: false, value: dD(t), writable: true });
  } : pD;
  Ld.exports = ED;
});
var Fd = c((e1, Md) => {
...
var Qt = c((s1, Qd) => {
  ...
  function kt(e) {
    this.__wrapped__ = e, this.__actions__ = [], this.__dir__ = 1, this.__filtered__ = false, this.__iteratees__ = [], this.__takeCount__ = wD, this.__views__ = [];
  }
...
var op = c((d1, ip) => {
  ...
  function JD(e) {
    var t = $D(e), r = ZD[t];
    if (typeof r != "function" || !(t in kD.prototype)) return false;
    if (e === r) return true;
    var n = QD(r);
    return !!n && e === n[0];
  }
  ...
  function sM(e) {
    return eM(function(t) {
      ...
      for (e && t.reverse(); n--; ) {
        ...
        if (i && !u && ui(o) == "wrapper") var u = new up([], true);
      }
      for (n = u ? n : r; ++n < r; ) {
        o = t[n];
...
var Mp = c((pi) => {
  ...
  Object.defineProperty(pi, "default", { enumerable: true, get: function() {
    return kM;
  } });
  ...
  var { MOUSE_CLICK: hM, MOUSE_SECOND_CLICK: TM, MOUSE_DOWN: yM, MOUSE_UP: OM, MOUSE_OVER: vM, MOUSE_OUT: AM, DROPDOWN_CLOSE: SM, DROPDOWN_OPEN: CM, SLIDER_ACTIVE: RM, SLIDER_INACTIVE: mM, TAB_ACTIVE: NM, TAB_INACTIVE: PM, NAVBAR_CLOSE: bM, NAVBAR_OPEN: LM, MOUSE_MOVE: DM, PAGE_SCROLL_DOWN: Sp, SCROLL_INTO_VIEW: Cp, SCROLL_OUT_OF_VIEW: MM, PAGE_SCROLL_UP: FM, SCROLLING_IN_VIEW: qM, PAGE_FINISH: Rp, ECOMMERCE_CART_CLOSE: wM, ECOMMERCE_CART_OPEN: xM, PAGE_START: mp, PAGE_SCROLL: GM } = pe.EventTypeConsts, ci = "COMPONENT_ACTIVE", Np = "COMPONENT_INACTIVE", { COLON_DELIMITER: gp } = pe.IX2EngineConstants, { getNamespacedParameterId: Ip } = IM.IX2VanillaUtils, Pp = (e) => (t) => typeof t == "object" && e(t) ? true : t, it = Pp(({ element: e, nativeEvent: t }) => e === t.target), VM = Pp(({ element: e, nativeEvent: t }) => e.contains(t.target)), Q = (0, EM.default)([it, VM]), bp = (e, t) => {
    ...
    return l && (0, si.stopActionGroup)({ store: e, eventId: s, eventTarget: r, eventStateKey: s + gp + n.split(gp)[1], actionListId: (0, _M.default)(l, "action.config.actionListId") }), (0, si.stopActionGroup)({ store: e, eventId: u, eventTarget: r, eventStateKey: n, actionListId: a }), (0, si.startActionGroup)({ store: e, eventId: u, eventTarget: r, eventStateKey: n, actionListId: a }), i;
  }, H = (e, t) => (r, n) => e(r, n) === true ? t(r, n) : n, ot = { handler: H(Q, X) }, Lp = { ...ot, types: [ci, Np].join(" ") }, li = [{ target: window, types: "resize orientationchange", throttle: true }, { target: document, types: "scroll wheel readystatechange IX2_PAGE_UPDATE", throttle: true }], hp = "mouseover mouseout", fi = { types: li }, UM = { PAGE_START: mp, PAGE_FINISH: Rp }, nt = (() => {
  ...
  })(), BM = (e, t) => !(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top), WM = ({ element: e, nativeEvent: t }) => {
    let { type: r, target: n, relatedTarget: i } = t, o = e.contains(n);
    if (r === "mouseover" && o) return true;
    let u = e.contains(i);
    ...
    return BM(t.getBoundingClientRect(), { left: 0, top: s, right: n, bottom: i - s });
  }, Dp = (e) => (t, r) => {
    let { type: n } = t.nativeEvent, i = [ci, Np].indexOf(n) !== -1 ? n === ci : r.isActive, o = { ...r, isActive: i };
    ...
    let I = a === Sp ? f >= h + E : f <= h - E, y = { ...r, percentTop: f, inBounds: I, anchorTop: h, scrollingDown: g };
    ...
    let n = { started: true };
    return r || e(t), n;
  }, Op = (e) => (t, r = { clickCount: 0 }) => {
    let n = { clickCount: r.clickCount % 2 + 1 };
    return n.clickCount !== r.clickCount && e(t, n) || n;
  }, Jt = (e = true) => ({ ...Lp, handler: H(e ? Q : it, Dp((t, r) => r.isActive ? ot.handler(t, r) : r)) }), er = (e = true) => ({ ...Lp, handler: H(e ? Q : it, Dp((t, r) => r.isActive ? r : ot.handler(t, r))) }), vp = { ...fi, handler: jM((e, t) => {
    let { elementVisible: r } = t, { event: n, store: i } = e, { ixData: o } = i.getState(), { events: u } = o;
    return !u[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === Cp === r ? (X(e), { ...t, triggered: true }) : t;
  }) }, Ap = 0.05, kM = { [RM]: Jt(), [mM]: er(), [CM]: Jt(), [SM]: er(), [LM]: Jt(false), [bM]: er(false), [NM]: Jt(), [PM]: er(), [xM]: { types: "ecommerce-cart-open", handler: H(Q, X) }, [wM]: { types: "ecommerce-cart-close", handler: H(Q, X) }, [hM]: { types: "click", handler: H(Q, Op((e, { clickCount: t }) => {
    XM(e) ? t === 1 && X(e) : X(e);
  })) }, [TM]: { types: "click", handler: H(Q, Op((e, { clickCount: t }) => {
    t === 2 && X(e);
  })) }, [yM]: { ...ot, types: "mousedown" }, [OM]: { ...ot, types: "mouseup" }, [vM]: { types: hp, handler: H(Q, Tp((e, t) => {
    t.elementHovered && X(e);
  })) }, [AM]: { types: hp, handler: H(Q, Tp((e, t) => {
    t.elementHovered || X(e);
  })) }, [DM]: { types: "mousemove mouseout scroll", handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
    let { basedOn: u, selectedAxis: a, continuousParameterGroupId: s, reverse: l, restingState: d = 0 } = r, { clientX: p = o.clientX, clientY: f = o.clientY, pageX: E = o.pageX, pageY: g = o.pageY } = n, _ = a === "X_AXIS", h = n.type === "mouseout", I = d / 100, y = s, A = false;
    switch (u) {
      ...
      default: {
        ...
        if (O && Q({ element: t, nativeEvent: n }) !== true) break;
        let C = t.getBoundingClientRect(), { left: T, top: S, width: v, height: R } = C;
        if (!O && !KM({ left: p, top: f }, C)) break;
        A = true, I = _ ? (p - T) / v : (f - S) / R;
        break;
      }
    }
    return h && (I > 1 - Ap || I < Ap) && (I = Math.round(I)), (u !== pe.EventBasedOn.ELEMENT || A || A !== o.elementHovered) && (I = l ? 1 - I : I, e.dispatch((0, Zt.parameterChanged)(y, I))), { elementHovered: A, clientX: p, clientY: f, pageX: E, pageY: g };
  } }, [GM]: { types: li, handler: ({ store: e, eventConfig: t }) => {
  ...
  } }, [qM]: { types: li, handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
    ...
    if (d === pe.EventBasedOn.VIEWPORT) {
      let O = A ? o / a : u / s;
      return O !== i.scrollPercent && t.dispatch((0, Zt.parameterChanged)(f, O)), { scrollPercent: O };
    } else {
      ...
      return b !== i.scrollPercent && t.dispatch((0, Zt.parameterChanged)(O, b)), { scrollPercent: b };
    }
  } }, [Cp]: vp, [MM]: vp, [Sp]: { ...fi, handler: yp((e, t) => {
    t.scrollingDown && X(e);
  }) }, [FM]: { ...fi, handler: yp((e, t) => {
    t.scrollingDown || X(e);
  }) }, [Rp]: { types: "readystatechange IX2_PAGE_UPDATE", handler: H(it, YM(X)) }, [mp]: { types: "readystatechange IX2_PAGE_UPDATE", handler: H(it, zM(X)) } };
});
var Ei = c((Ai) => {
  ...
  QM(Ai, { observeRequests: function() {
    return SF;
  ...
  function SF(e) {
    Ee({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: mF }), Ee({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: NF }), Ee({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: PF }), Ee({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: bF });
  }
  function CF(e) {
    Ee({ store: e, select: ({ ixSession: t }) => t.mediaQueryKey, onChange: () => {
      ur(e), Vp({ store: e, elementApi: F }), or({ store: e, allowEvents: true }), Xp();
    } });
  }
  function RF(e, t) {
    let r = Ee({ store: e, select: ({ ixSession: n }) => n.tick, onChange: (n) => {
      t(n), r();
    } });
  }
  function mF({ rawData: e, defer: t }, r) {
    let n = () => {
      or({ store: r, rawData: e, allowEvents: true }), Xp();
    };
    t ? setTimeout(n, 0) : n();
  }
  function Xp() {
  ...
  function NF(e, t) {
    let { actionTypeId: r, actionListId: n, actionItemId: i, eventId: o, allowEvents: u, immediate: a, testManual: s, verbose: l = true } = e, { rawData: d } = e;
    if (n && i && d && a) {
      let p = d.actionLists[n];
      p && (d = pF({ actionList: p, actionItemId: i, rawData: d }));
    }
    if (or({ store: t, rawData: d, allowEvents: u, testManual: s }), n && r === B.ActionTypeConsts.GENERAL_START_ACTION || _i(r)) {
      Ti({ store: t, actionListId: n }), Bp({ store: t, actionListId: n, eventId: o });
      let p = yi({ store: t, eventId: o, actionListId: n, immediate: a, verbose: l });
      l && p && t.dispatch((0, M.actionListPlaybackChanged)({ actionListId: n, isPlaying: !a }));
    }
  }
  ...
  function or({ store: e, rawData: t, allowEvents: r, testManual: n }) {
    ...
    t && e.dispatch((0, M.rawDataImported)(t)), i.active || (e.dispatch((0, M.sessionInitialized)({ hasBoundaryNodes: !!document.querySelector(tr), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })), r && (wF(e), LF(), e.getState().ixSession.hasDefinedMediaQueries && CF(e)), e.dispatch((0, M.sessionStarted)()), DF(e, n));
  }
  function LF() {
  ...
  function FF({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: u, smoothing: a, restingValue: s }) {
    ...
    I.forEach((O) => {
      ...
      T.forEach((S) => {
        ...
        if (_[N] = qF(_[N], C, S), !g[N]) {
          g[N] = true;
          let { config: P } = S;
          rr({ config: P, event: f, eventTarget: r, elementRoot: m, elementApi: F }).forEach((b) => {
            h.push({ element: b, key: N });
          });
        }
      });
    }), h.forEach(({ element: O, key: C }) => {
      let T = _[C], S = (0, oe.default)(T, "[0].actionItems[0]", {}), { actionTypeId: v } = S, m = (v === B.ActionTypeConsts.PLUGIN_RIVE ? (S.config?.target?.selectorGuids || []).length === 0 : ir(v)) ? hi(v)?.(O, S) : null, N = Ii({ element: O, actionItem: S, elementApi: F }, m);
      Oi({ store: e, element: O, eventId: n, actionListId: o, actionItem: S, destination: N, continuous: true, parameterId: y, actionGroups: T, smoothing: a, restingValue: s, pluginInstance: m });
    });
  }
  function qF(e = [], t, r) {
    let n = [...e], i;
    return n.some((o, u) => o.keyframe === t ? (i = u, true) : false), i == null && (i = n.length, n.push({ keyframe: t, actionItems: [] })), n[i].actionItems.push(r), n;
  }
  function wF(e) {
  ...
  function GF(e) {
    ...
    xF.forEach((r) => {
      window.addEventListener(r, t), e.dispatch((0, M.eventListenerAdded)(window, [r, t]));
    }), t();
  }
  function Up(e) {
  ...
  function BF({ logic: e, store: t, events: r }) {
    ...
    (0, ut.default)(a, (p, f) => {
      ...
      TF(h, o.mediaQueryKeys) || t.dispatch((0, M.mediaQueriesDefined)()), g.actionTypeId === B.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(E.config) ? E.config : [E.config]).forEach((A) => {
        let { continuousParameterGroupId: O } = A, C = (0, oe.default)(u, `${I}.continuousParameterGroups`, []), T = (0, $M.default)(C, ({ id: R }) => R === O), S = (A.smoothing || 0) / 100, v = (A.restingState || 0) / 100;
        T && p.forEach((R, m) => {
          let N = _ + gi + m;
          FF({ store: t, eventStateKey: N, eventTarget: R, eventId: _, eventConfig: A, actionListId: I, parameterGroup: T, smoothing: S, restingValue: v });
        });
      }), (g.actionTypeId === B.ActionTypeConsts.GENERAL_START_ACTION || _i(g.actionTypeId)) && Bp({ store: t, actionListId: I, eventId: _ });
    });
    let s = (p) => {
      ...
      XF(a, (E, g, _) => {
        ...
        let O = (C = {}) => {
          let T = i({ store: t, element: E, event: h, eventConfig: C, nativeEvent: p, eventStateKey: _ }, I);
          yF(T, I) || t.dispatch((0, M.eventStateChanged)(_, T));
        };
        y.actionTypeId === B.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(h.config) ? h.config : [h.config]).forEach(O) : O();
      });
    }, l = (0, rF.default)(s, AF), d = ({ target: p = document, types: f, throttle: E }) => {
      f.split(" ").filter(Boolean).forEach((g) => {
        let _ = E ? l : s;
        p.addEventListener(g, _), t.dispatch((0, M.eventListenerAdded)(p, [g, _]));
      });
    };
  ...
  function WF(e) {
    ...
    for (let n in e) {
      ...
      t[u] || (i === B.EventTypeConsts.MOUSE_CLICK || i === B.EventTypeConsts.MOUSE_SECOND_CLICK) && (t[u] = true, r += u + "{cursor: pointer;touch-action: manipulation;}");
    }
    if (r) {
  ...
  function Bp({ store: e, actionListId: t, eventId: r }) {
    ...
    if (s && s.useFirstGroupAsInitialState) {
      ...
      l.forEach((p) => {
        let { config: f, actionTypeId: E } = p, g = f?.target?.useEventTarget === true && f?.target?.objectId == null ? { target: a.target, targets: a.targets } : f, _ = rr({ config: g, event: a, elementApi: F }), h = ir(E);
        _.forEach((I) => {
          let y = h ? hi(E)?.(I, p) : null;
          Oi({ destination: Ii({ element: I, actionItem: p, elementApi: F }, y), immediate: true, store: e, element: I, eventId: r, actionItem: p, actionListId: t, pluginInstance: y });
        });
      });
    }
  }
  function Wp({ store: e }) {
    ...
    (0, ut.default)(t, (r) => {
      if (!r.continuous) {
        ...
        vi(r, e), i && e.dispatch((0, M.actionListPlaybackChanged)({ actionListId: n, isPlaying: false }));
      }
    });
  }
  function Ti({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i }) {
    let { ixInstances: o, ixSession: u } = e.getState(), a = u.hasBoundaryNodes && r ? F.getClosestElement(r, tr) : null;
    (0, ut.default)(o, (s) => {
      let l = (0, oe.default)(s, "actionItem.config.target.boundaryMode"), d = n ? s.eventStateKey === n : true;
      if (s.actionListId === i && s.eventId === t && d) {
        if (a && l && !F.elementContains(a, s.element)) return;
        vi(s, e), s.verbose && e.dispatch((0, M.actionListPlaybackChanged)({ actionListId: i, isPlaying: false }));
      }
    });
  }
  function yi({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o = 0, immediate: u, verbose: a }) {
    let { ixData: s, ixSession: l } = e.getState(), { events: d } = s, p = d[t] || {}, { mediaQueries: f = s.mediaQueryKeys } = p, E = (0, oe.default)(s, `actionLists.${i}`, {}), { actionItemGroups: g, useFirstGroupAsInitialState: _ } = E;
    if (!g || !g.length) return false;
    o >= g.length && (0, oe.default)(p, "config.loop") && (o = 0), o === 0 && _ && o++;
    let I = (o === 0 || o === 1 && _) && _i(p.action?.actionTypeId) ? p.config.delay : void 0, y = (0, oe.default)(g, [o, "actionItems"], []);
    if (!y.length || !nr(f, l.mediaQueryKey)) return false;
    let A = l.hasBoundaryNodes && r ? F.getClosestElement(r, tr) : null, O = lF(y), C = false;
    return y.forEach((T, S) => {
      let { config: v, actionTypeId: R } = T, m = ir(R), { target: N } = v;
      if (!N) return;
      let P = N.boundaryMode ? A : null;
      rr({ config: v, event: p, eventTarget: r, elementRoot: P, elementApi: F }).forEach((q, Ri) => {
        let sr = m ? hi(R)?.(q, T) : null, cr = m ? OF(R)(q, T) : null;
        C = true;
        let kp = O === S && Ri === 0, Qp = fF({ element: q, actionItem: T }), $p = Ii({ element: q, actionItem: T, elementApi: F }, sr);
        Oi({ store: e, element: q, actionItem: T, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o, isCarrier: kp, computedStyle: Qp, destination: $p, immediate: u, verbose: a, pluginInstance: sr, pluginDuration: cr, instanceDelay: I });
      });
    }), C;
  }
  function Oi(e) {
    ...
    if (A && s) switch (_.events[d]?.eventTypeId) {
    ...
    if (t.dispatch((0, M.instanceAdded)({ instanceId: f, elementId: h, origin: C, refType: y, skipMotion: A, skipToValue: O, ...n })), Hp(document.body, "ix2-animation-started", f), u) {
      HF(t, f);
      return;
    }
    Ee({ store: t, select: ({ ixInstances: T }) => T[f], onChange: jp }), p && t.dispatch((0, M.instanceStarted)(f, g.tick));
  }
  function vi(e, t) {
    Hp(document.body, "ix2-animation-stopping", { instanceId: e.id, state: t.getState() });
  ...
  function Hp(e, t, r) {
    ...
    n.initCustomEvent(t, true, true, r), e.dispatchEvent(n);
  }
  function HF(e, t) {
  ...
  function jp(e, t) {
    ...
    if (nr(S, O.mediaQueryKey) && (n || r || i)) {
      ...
      if (i) {
        if (_) {
          let v = yi({ store: t, eventId: p, eventTarget: f, eventStateKey: E, actionListId: g, groupIndex: d + 1, verbose: I });
          I && !v && t.dispatch((0, M.actionListPlaybackChanged)({ actionListId: g, isPlaying: false }));
        }
        vi(e, t);
      }
    }
...
var zp = c((Ci) => {
  ...
  function ZF(e) {
    Yp(), (0, Si.startEngine)({ store: ar, rawData: e, allowEvents: true });
  }
  function Yp() {
    (0, Si.stopEngine)(ar);
  }
...
const DevLinkContext = React.createContext({});
const DevLinkProvider = ({ children, ...context }) => React.createElement(
  DevLinkContext.Provider,
  { value: context },
  React.createElement(InteractionsProvider, { createEngine: JF }, children)
);

const Block = reactExports.forwardRef(function Block2({ tag = "div", ...props }, ref) {
  return reactExports.createElement(tag, {
    ...props,
    ref
  });
});
const Span = reactExports.forwardRef(function Span2(props, ref) {
  return reactExports.createElement("span", { ...props, ref });
});
reactExports.forwardRef(function Blockquote2(props, ref) {
  return reactExports.createElement("blockquote", { ...props, ref });
});
const Link = reactExports.forwardRef(function Link2({ options = { href: "#" }, className = "", button = false, children, block = "", ...props }, ref) {
  const { renderLink: UserLink } = reactExports.useContext(DevLinkContext);
  if (button)
    className += " w-button";
  if (block === "inline")
    className += " w-inline-block";
  if (UserLink) {
    return reactExports.createElement(UserLink, { className, ...options, ...props, ref }, children);
  }
  ...
  return reactExports.createElement(
    ...
    null,
    reactExports.createElement("a", { href, target, className, ...props, ref }, children),
    shouldRenderResource && reactExports.createElement("link", { rel: preload, href })
  );
});
reactExports.forwardRef(function List2({ tag = "ul", unstyled = true, className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
    role: "list",
...
reactExports.forwardRef(function ListItem2(props, ref) {
  return reactExports.createElement("li", {
    ...props,
    ref
  });
});
const Image = reactExports.forwardRef(function Image2({ alt, ...props }, ref) {
  const { renderImage: UserImage } = reactExports.useContext(DevLinkContext);
  return UserImage ? reactExports.createElement(UserImage, { alt: alt || "", ...props, ref }) : reactExports.createElement("img", { alt: alt || "", ...props, ref });
});
const Section = reactExports.forwardRef(function Section2({ tag = "section", ...props }, ref) {
  return reactExports.createElement(tag, {
    ...props,
    ref
  });
});
const Container = reactExports.forwardRef(function Container2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function BlockContainer2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function HFlex2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function VFlex2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function Layout2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function Cell2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
const HtmlEmbed = reactExports.forwardRef(function HtmlEmbed2({ tag = "div", className = "", value = "", ...props }, ref) {
  return reactExports.createElement(tag, {
    className: className + " w-embed",
    dangerouslySetInnerHTML: { __html: removeUnescaped(value) },
    ...props,
    ref
  });
});
const Grid = reactExports.forwardRef(function Grid2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function Icon2({ widget, className = "", ...props }, ref) {
...
const Column = reactExports.forwardRef(function Column2({ tag = "div", className = "", columnClasses = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function Row2({ tag = "div", className = "", columns, children, ...props }, ref) {
  return reactExports.createElement(tag, { className: className + " w-row", ...props, ref }, columns ? reactExports.Children.map(children, (child, index) => {
...
reactExports.forwardRef(function DOM2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
    className,
    ...props,
    ref
...
reactExports.forwardRef(function NotSupported2({ _atom = "" }, ref) {
  return reactExports.createElement("div", { ref }, `This builtin is not currently supported: ${_atom}`);
});
...
reactExports.forwardRef(function TabsWrapper2({ className = "", fadeIn, fadeOut, easing, current: initialCurrent, ...props }, ref) {
  const [current, setCurrent] = reactExports.useState("");
  const changeTab = reactExports.useCallback((next) => {
    function updateTab() {
      setCurrent(() => {
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement("div", { ...props, className: cj(className, "w-tabs"), ref })
  );
});
reactExports.forwardRef(function TabsMenu2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
    ...props,
...
reactExports.forwardRef(function TabsLink2({ className = "", children, ...props }, ref) {
  const { current, onTabClick, onLinkKeyDown } = reactExports.useContext(tabsContext);
  const isCurrent = current === props["data-w-tab"];
  const innerRef = reactExports.useCallback((node) => {
    if (!node)
      return;
  ...
  return reactExports.createElement("a", { ...props, ref: innerRef, className: cj(className, "w-inline-block w-tab-link", isCurrent && "w--current"), onClick: () => onTabClick(props["data-w-tab"]), onKeyDown: onLinkKeyDown, role: "tab", tabIndex: isCurrent ? 0 : -1, "aria-selected": isCurrent, "aria-controls": props["data-w-tab"] }, children);
});
reactExports.forwardRef(function TabsContent2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
    ...props,
...
reactExports.forwardRef(function TabsPane2({ tag = "div", className = "", ...props }, ref) {
  const { current } = reactExports.useContext(tabsContext);
  const isCurrent = current === props["data-w-tab"];
  return reactExports.createElement(tag, {
    ...props,
...
function getLinksList$1(root) {
  return root.querySelectorAll(".w-nav-menu .w-nav-link");
}
const NavbarContext = reactExports.createContext({
  animDirect: 1,
  animOver: false,
  animation: "animation",
  collapse: "medium",
...
const NavbarWrapper = reactExports.forwardRef(function NavbarWrapper2(props, ref) {
  ...
  const [focusedLink, setFocusedLink] = reactExports.useState(-1);
  reactExports.useImperativeHandle(ref, () => root.current);
  const getBodyHeight = reactExports.useCallback(() => {
    if (isServer)
      return;
    return docHeight ? document.documentElement.scrollHeight : document.body.scrollHeight;
  }, [docHeight]);
  const getOverlayHeight = reactExports.useCallback(() => {
  ...
  const getOffsetHeight = reactExports.useCallback(() => {
  ...
  const closeOnResize = reactExports.useCallback(() => setIsOpen(false), [setIsOpen]);
  useResizeObserver(root, closeOnResize, { onlyWidth: true });
  reactExports.useEffect(() => {
    if (root.current) {
      const links = getLinksList$1(root.current);
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement(Navbar, { ...props })
  );
});
const maybeExtractChildMenu = (children, isOpen) => {
  if (!isOpen)
    return { childMenu: null, rest: children };
  const { extracted, tree } = extractElement(reactExports.Children.toArray(children), NavbarMenu);
  return { childMenu: extracted, rest: tree };
};
function Navbar({ tag = "div", className = "", children, config, ...props }) {
  const { root, collapse, setFocusedLink } = reactExports.useContext(NavbarContext);
  const [shouldExtractMenu, setShouldExtractMenu] = reactExports.useState(true);
  const extractMenuCallback = reactExports.useCallback((entry) => {
    setShouldExtractMenu(entry.contentRect.width <= BREAKPOINTS[collapse]);
  }, [setShouldExtractMenu]);
  const bodyRef = reactExports.useRef(typeof document !== "undefined" ? document.body : null);
  useResizeObserver(bodyRef, extractMenuCallback);
  const { childMenu, rest } = reactExports.useMemo(() => maybeExtractChildMenu(children, shouldExtractMenu), [children, shouldExtractMenu]);
  const handleFocus = (e) => {
    const inputFocused = document.activeElement?.tagName.toLowerCase() === "input";
    const linkList = root.current ? Array.from(getLinksList$1(root.current)) : [];
  ...
  return reactExports.createElement(tag, {
    ...
    null,
    rest,
    reactExports.createElement(NavbarOverlay, null, childMenu)
  ));
}
function NavbarOverlay({ children }) {
  const { isOpen, getOverlayHeight, toggleOpen } = reactExports.useContext(NavbarContext);
  const overlayToggleOpen = reactExports.useCallback((e) => {
    if (e.target === e.currentTarget) {
      toggleOpen();
    }
  }, [toggleOpen]);
  const overlayHeight = getOverlayHeight();
  return reactExports.createElement("div", { className: "w-nav-overlay", id: "w-nav-overlay", style: {
    display: isOpen ? "block" : "none",
    height: overlayHeight ? overlayHeight : void 0,
    width: isOpen ? "100%" : 0
  }, onClick: overlayToggleOpen, onKeyDown: overlayToggleOpen }, children);
}
reactExports.forwardRef(function NavbarContainer2({ children, ...props }, ref) {
  const innerRef = reactExports.useRef(null);
  const { isOpen } = reactExports.useContext(NavbarContext);
  reactExports.useImperativeHandle(ref, () => innerRef.current);
  const updateLinkStyles = reactExports.useCallback((entry) => {
  ...
  return reactExports.createElement(Container, { ...props, ref: innerRef }, children);
});
reactExports.forwardRef(function NavbarBrand2({ className = "", ...props }, ref) {
  return reactExports.createElement(Link, { ...props, className: cj(className, "w-nav-brand"), ref });
});
const NavbarMenu = reactExports.forwardRef(function NavbarMenu2({ tag = "nav", className = "", ...props }, ref) {
  const { getBodyHeight, animOver, isOpen, menu } = reactExports.useContext(NavbarContext);
  reactExports.useImperativeHandle(ref, () => menu.current);
  return reactExports.createElement(tag, {
    ...props,
...
reactExports.forwardRef(function NavbarLink2({ className = "", ...props }, ref) {
  const { isOpen } = reactExports.useContext(NavbarContext);
  return reactExports.createElement(Link, { ...props, className: cj(className, "w-nav-link", isOpen && "w--nav-link-open"), ref });
});
reactExports.forwardRef(function NavbarButton2({ tag = "div", className = "", ...props }, ref) {
  const { isOpen, toggleOpen } = reactExports.useContext(NavbarContext);
  return reactExports.createElement(tag, {
    ...props,
    "aria-label": "menu",
...
reactExports.forwardRef(function DropdownWrapper2({ delay, hover, ...props }, ref) {
  const root = reactExports.useRef(null);
  const [{ isOpen }, setIsOpen] = reactExports.useState(INITIAL_DROPDOWN_STATE);
  const [focusedLink, setFocusedLink] = reactExports.useState(-1);
  const closeTimeoutRef = reactExports.useRef();
  reactExports.useImperativeHandle(ref, () => root.current);
  reactExports.useEffect(() => {
    return () => {
  ...
  const closeDropdown = reactExports.useCallback(() => setIsOpen(INITIAL_DROPDOWN_STATE), [setIsOpen]);
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement(Dropdown, { ...props })
  );
});
function Dropdown({ tag = "div", className = "", ...props }) {
  const { root, setFocusedLink, hover, toggleOpen } = reactExports.useContext(DropdownContext);
  const { isOpen: isNavbarOpen } = reactExports.useContext(NavbarContext);
  const handleFocus = (e) => {
...
reactExports.forwardRef(function DropdownToggle2({ tag = "div", className = "", ...props }, ref) {
  const { isOpen, toggleOpen, hover } = reactExports.useContext(DropdownContext);
  const { isOpen: isNavbarOpen } = reactExports.useContext(NavbarContext);
  return reactExports.createElement(tag, {
    ...props,
    "aria-haspopup": "menu",
...
reactExports.forwardRef(function DropdownList2({ tag = "nav", className = "", ...props }, ref) {
  const { isOpen } = reactExports.useContext(DropdownContext);
  const { isOpen: isNavbarOpen } = reactExports.useContext(NavbarContext);
  return reactExports.createElement(tag, {
    ...props,
...
reactExports.forwardRef(function DropdownLink2({ className = "", ...props }, ref) {
  const { isOpen: isNavbarOpen } = reactExports.useContext(NavbarContext);
...
reactExports.forwardRef(function Facebook2({ className = "", layout = "standard", width = 250, height = 50, url = "https://facebook.com/webflow", locale = "en_US", ...props }, ref) {
  if (!isUrl(url)) {
  ...
  return reactExports.createElement(
    "div",
    { ...props, className: className + " w-widget w-widget-facebook", ref },
    reactExports.createElement("iframe", { title: "Facebook Like Button", src: frameSrc, style: { border: "none", overflow: "hidden", width, height } })
  );
});

const Heading = reactExports.forwardRef(function Heading2({ tag = "h1", ...props }, ref) {
  return reactExports.createElement(tag, {
    ...props,
    ref
  });
});
const Paragraph = reactExports.forwardRef(function Paragraph2(props, ref) {
  return reactExports.createElement("p", {
    ...props,
    ref
  });
});
reactExports.forwardRef(function Emphasized2(props, ref) {
  return reactExports.createElement("em", { ...props, ref });
});
reactExports.forwardRef(function Strong2(props, ref) {
  return reactExports.createElement("strong", {
    ...props,
    ref
  });
});
reactExports.forwardRef(function Figure2({ className = "", figure, ...props }, ref) {
  ...
  return reactExports.createElement("figure", { className, ...props, ref });
});
reactExports.forwardRef(function Figcaption2(props, ref) {
  return reactExports.createElement("figcaption", { ...props, ref });
});
reactExports.forwardRef(function Subscript2(props, ref) {
  return reactExports.createElement("sub", { ...props, ref });
});
reactExports.forwardRef(function Superrscript(props, ref) {
  return reactExports.createElement("sup", { ...props, ref });
});
reactExports.forwardRef(function RichText2({ tag = "div", className = "", ...props }, ref) {
  return reactExports.createElement(tag, {
...
reactExports.forwardRef(function Twitter2({ className = "", url = "https://webflow.com", mode = "tweet", size = "m", text = "Check out this site", ...props }, ref) {
  const innerRef = reactExports.useRef(null);
  reactExports.useImperativeHandle(ref, () => innerRef.current);
  if (!isUrl(url)) {
    if (mode === "tweet") {
  ...
  return reactExports.createElement("div", { ...props, className: className + " w-widget w-widget-twitter", ref: innerRef });
});

function onKeyDownInputHandlers(e) {
  e.stopPropagation();
}
React.forwardRef(function FormWrapper2({ className = "", state: initialState = "normal", onSubmit, children, ...props }, ref) {
...
const FormForm = React.forwardRef(function FormForm2(props, ref) {
  return React.createElement("form", { ...props, ref });
});
React.forwardRef(function FormBlockLabel2(props, ref) {
  return React.createElement("label", { ...props, ref });
});
React.forwardRef(function FormTextInput2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormTextarea2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormInlineLabel2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormCheckboxWrapper2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormRadioWrapper2({ className = "", ...props }, ref) {
  return React.createElement("label", {
...
const FormBooleanInput = React.forwardRef(function FormBooleanInput2({ className = "", checked = false, type = "checkbox", inputType, customClassName, ...props }, ref) {
  ...
  if (inputType === "custom") {
    ...
    return React.createElement(
      ...
      React.createElement("input", { ref, ...props, ...inputProps, style: HIDE_DEFAULT_INPUT_STYLES })
    );
  }
  return React.createElement("input", { ref, className, ...props, ...inputProps });
});
React.forwardRef(function FormCheckboxInput2({ className = "", ...props }, ref) {
  return React.createElement(FormBooleanInput, { ...props, ref, type: "checkbox", className: className + " w-checkbox-input" });
});
React.forwardRef(function FormRadioInput2({ className = "", ...props }, ref) {
  return React.createElement(FormBooleanInput, { ...props, ref, type: "radio", className: className + " w-radio-input" });
});
...
React.forwardRef(function FormFileUploadWrapper2({ maxSize = MAX_FILE_SIZE_DEFAULT, ...props }, ref) {
...
const _FormFileUploadWrapper = React.forwardRef(function _FormFileUploadWrapper2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadDefault2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormFileUploadInput2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormFileUploadLabel2({ className = "", ...props }, ref) {
  return React.createElement("label", {
...
React.forwardRef(function FormFileUploadText2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadInfo2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadUploading2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadUploadingBtn2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadUploadingIcon2({ className = "", ...props }, ref) {
  return React.createElement("svg", {
    ...
    React.createElement(
      "path",
      { fill: "currentColor", opacity: ".75", d: "M0 15A15 15 0 0 1 15 0v3A12 12 0 0 0 3 15H0z" },
...
React.forwardRef(function FormFileUploadSuccess2({ className = "", ...props }, ref) {
  const { files, error } = React.useContext(FileUploadContext);
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadFile2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormFileUploadFileName2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormFileUploadRemoveLink2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormFileUploadError2({ className = "", ...props }, ref) {
...
React.forwardRef(function FormFileUploadErrorMsg2({ errors, className = "", ...props }, ref) {
  const { error } = React.useContext(FileUploadContext);
  return React.createElement("div", {
...
React.forwardRef(function FormButton2({ className = "", value, ...props }, ref) {
  return React.createElement("input", {
    ...props,
    ref,
    type: "submit",
...
React.forwardRef(function SearchForm2(props, ref) {
  return React.createElement("form", { ...props, ref });
});
React.forwardRef(function SearchInput2({ className = "", ...props }, ref) {
  return React.createElement("input", {
    ...props,
    type: "text",
    className: className + " w-input",
...
React.forwardRef(function SearchButton2({ value = "", className = "", ...props }, ref) {
  return React.createElement("input", {
    ...props,
    type: "submit",
    value,
...
const FormSuccessMessage = React.forwardRef(function FormSuccessMessage2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
const FormErrorMessage = React.forwardRef(function FormErrorMessage2({ className = "", ...props }, ref) {
  return React.createElement("div", {
...
React.forwardRef(function FormSelect2({ options, className = "", ...props }, ref) {
...
React.forwardRef(function FormReCaptcha2({ siteKey = "", theme = "light", size = "normal" }, ref) {
  React.useEffect(() => {
    loadScript("https://www.google.com/recaptcha/api.js", {
      cacheRegex: /(http|https):\/\/(www)?.+\/recaptcha/
    });
  }, []);
  return React.createElement("div", { ref, className: "g-recaptcha", "data-sitekey": siteKey, "data-theme": theme, "data-size": size });
});
...
React.forwardRef(function MapWidget2({ apiKey = "", mapStyle = "roadmap", zoom = 12, latlng = "51.511214,-0.119824", tooltip = "", title = "", enableScroll = true, enableTouch = true, className = "", ...props }, ref) {
...
const SliderContext = reactExports.createContext({
  ...
  slideAmount: 0,
  setSlideAmount: () => void 0,
  setCurrentSlide: () => void 0,
  goToNextSlide: () => void 0,
  goToPreviousSlide: () => void 0,
  slide: { current: 0, previous: 0 },
  isAutoplayPaused: false,
  setAutoplayPause: () => void 0
});
function useSwipe({ onSwipeLeft, onSwipeRight, config }) {
  const SWIPE_DELTA = 150;
  const [touchStart, setTouchStart] = reactExports.useState(0);
  const [touchEnd, setTouchEnd] = reactExports.useState(0);
...
reactExports.forwardRef(function SlideWrapper({ className = "", ...props }, ref) {
  const [slideAmount, setSlideAmount] = reactExports.useState(0);
  const [selectedSlide, setSelectedSlide] = reactExports.useState(0);
  const [prevSelectedSlide, setPrevSelectedSlide] = reactExports.useState(0);
  const [isAutoplayPaused, setAutoplayPause] = reactExports.useState(false);
  ...
  return reactExports.createElement(
    ...
    reactExports.createElement("div", { ...swipeHandlers, className: cj(className, "w-slider"), role: "region", "aria-label": "carousel", ref }, props.children)
  );
});
function useAutoplay() {
  const { autoplay, delay, autoMax, isAutoplayPaused, setAutoplayPause, goToNextSlide } = reactExports.useContext(SliderContext);
  const [autoMaxCount, setAutoMaxCount] = reactExports.useState(0);
  const autoMaxReached = reactExports.useMemo(() => autoMaxCount >= autoMax && autoMax > 0, [autoMax, autoMaxCount]);
  reactExports.useEffect(() => {
...
reactExports.forwardRef(function SliderMask2({ className = "", children, ...props }, ref) {
  const { setSlideAmount } = reactExports.useContext(SliderContext);
  ...
  reactExports.useEffect(() => {
    const extractNonFragmentChildren = (_children) => {
      const childrenList = reactExports.Children.toArray(_children).filter((child) => reactExports.isValidElement(child));
      if (childrenList.length === 1 && childrenList[0]?.type === reactExports.Fragment) {
  ...
  return reactExports.createElement(
    "div",
    { ...props, className: cj(className, "w-slider-mask"), onMouseEnter: () => {
      pauseAutoplay();
      setHovered(true);
    }, onMouseLeave: () => {
      resumeAutoplay();
      setHovered(false);
    }, onFocus: () => pauseAutoplay(), onBlur: () => resumeAutoplay(), ref },
    ...
    reactExports.createElement("div", { "aria-live": isHovered ? "polite" : "off", "aria-atomic": "true", className: "w-slider-aria-label" })
  );
});
reactExports.forwardRef(function SliderSlide2({ tag = "div", className = "", style = {}, index, ...props }, ref) {
  const { animation, duration, easing, slide: { current, previous }, slideAmount } = reactExports.useContext(SliderContext);
  const { restartEngine } = reactExports.useContext(IXContext);
  reactExports.useEffect(() => {
    restartEngine && restartEngine();
  }, [restartEngine]);
  const isSlideActive = current === index;
  const isSlidePrevious = previous === index;
  const animationStyle = reactExports.useMemo(() => {
    const base = {
...
reactExports.forwardRef(function SliderArrow2({ className = "", dir = "left", children, ...props }, ref) {
  const { goToNextSlide, goToPreviousSlide, hideArrows, slideAmount, slide: { current } } = reactExports.useContext(SliderContext);
  ...
  return reactExports.createElement("div", { ...props, onClick: handleSlideChange, onKeyDown: (e) => {
    e.stopPropagation();
    if (e.key === KEY_CODES.ENTER || e.key === KEY_CODES.SPACE) {
      e.preventDefault();
      handleSlideChange();
    }
  }, role: "button", tabIndex: 0, className: cj(className, `w-slider-arrow-${dir}`), "aria-label": `${dir === "left" ? "previous" : "next"} slide`, style: { display: isHidden ? "none" : "block" }, ref }, children);
});
reactExports.forwardRef(function SliderNav2({ className = "", ...props }, ref) {
  const { slideAmount, navInvert, navNumbers, navRound, navShadow, setAutoplayPause, setCurrentSlide } = reactExports.useContext(SliderContext);
  const [focusedDot, setFocusedDot] = reactExports.useState(null);
  const handleFocus = (e) => {
    switch (e.key) {
  ...
  const dots = [...Array(slideAmount).keys()].map((_, i) => {
    return reactExports.createElement(SliderDot, { key: i, index: i, focusedDot, handleFocus, setFocusedDot });
  });
  return reactExports.createElement("div", { ...props, onFocus: (e) => {
    e.stopPropagation();
    setAutoplayPause(true);
  }, onBlur: () => {
    setAutoplayPause(false);
  }, onMouseLeave: (e) => e.stopPropagation(), className: cj(className, `w-slider-nav ${navInvert ? "w-slider-nav-invert" : ""} ${navShadow ? "w-shadow" : ""} ${navRound ? "w-round" : ""} ${navNumbers ? "w-num" : ""}`), ref }, dots);
});
const SliderDot = reactExports.forwardRef(function SliderDot2({ index, focusedDot, handleFocus, setFocusedDot }, ref) {
  const { slideAmount, navSpacing, navNumbers, slide: { current: selectedSlide }, setCurrentSlide } = reactExports.useContext(SliderContext);
  const innerRef = reactExports.useRef(null);
  reactExports.useImperativeHandle(ref, () => innerRef.current);
  reactExports.useEffect(() => {
    if (focusedDot === index) {
  ...
  return reactExports.createElement("div", { className: `w-slider-dot ${isSlideActive ? "w-active" : ""}`, "aria-label": `Show slide ${index + 1} of ${slideAmount}`, "aria-pressed": isSlideActive, role: "button", tabIndex: isSlideActive ? 0 : -1, style: {
...
React.forwardRef(function Video2({ className = "", options, ...props }, ref) {
  const { height = 0, width = 0, title = "", url = void 0 } = options || {};
  const aspectRatio = getAspectRatio({ width, height });
  return React.createElement(
    "div",
    { ...props, style: { paddingTop: `${aspectRatio * 100}%` }, className: cj("w-video", "w-embed", className), ref },
    React.createElement("iframe", { className: "embedly-embed", src: url, width, height, title, allowFullScreen: true, scrolling: "no", frameBorder: "0" })
  );
});

const DEFAULT_16_9_RATIO = 0.5617021276595745;
reactExports.forwardRef(function YouTubeVideo2({ className = "", title, videoId, aspectRatio = DEFAULT_16_9_RATIO, startAt = 0, showAllRelatedVideos = false, controls = true, autoplay = false, muted = false, privacyMode = false, ...props }, ref) {
  ...
  return reactExports.createElement(
    "div",
    { ...props, style: { paddingTop: `${aspectRatio * 100}%` }, className: cj("w-embed-youtubevideo", className), ref },
    reactExports.createElement("iframe", { src: `${baseUrl}/${videoId}?${urlParams}`, title, allowFullScreen: true, scrolling: "no", frameBorder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share", style: iframeStyle })
  );
});

const BgVideoContext = React.createContext({ isPlaying: true, togglePlay: () => void 0 });
React.forwardRef(function BackgroundVideoWrapper2({ tag = "div", className = "", autoPlay = true, loop = true, sources = [], posterImage = "", children }, ref) {
  ...
  return React.createElement(
    ...
    }, React.createElement("video", { ref: video, autoPlay, loop, style: posterImage ? { backgroundImage: `url("${posterImage}")` } : void 0, muted: true, playsInline: true }, sources.map((url) => React.createElement("source", { src: url, key: url })))),
    children
  );
});
React.forwardRef(function BackgroundVideoPlayPauseButton2({ children, className }, ref) {
  const { togglePlay } = React.useContext(BgVideoContext);
  return React.createElement(
    "div",
    { "aria-live": "polite" },
    React.createElement("button", { type: "button", className: cj(className, "w-backgroundvideo-backgroundvideoplaypausebutton", "w-background-video--control"), onClick: togglePlay, ref }, children)
  );
});
React.forwardRef(function BackgroundVideoPlayPauseButtonPlaying2({ children }, ref) {
  const { isPlaying } = React.useContext(BgVideoContext);
  return React.createElement("span", { hidden: !isPlaying, ref }, children);
});
React.forwardRef(function BackgroundVideoPlayPauseButtonPaused2({ children }, ref) {
  const { isPlaying } = React.useContext(BgVideoContext);
  return React.createElement("span", { hidden: isPlaying, ref }, children);
});
...
function NavigationWrapper() {
  reactExports.useEffect(() => {
    const updateLinks = () => {
      ...
      links.forEach((link) => {
        ...
        if (href === "#" && link.querySelector(".home-button")) {
          link.setAttribute("href", "https://patricia-lanning.webflow.io/");
          console.log("Updated Home link");
        } else if (href === "/memory-journal" || text === "Share a Memory") {
          link.setAttribute("href", `${baseUrl}/`);
          console.log("Updated Share a Memory link to:", `${baseUrl}/`);
        } else if (href === "/guestbook" || text === "Guestbook") {
          link.setAttribute("href", `${baseUrl}/guestbook`);
          console.log("Updated Guestbook link to:", `${baseUrl}/guestbook`);
        } else if (text === "Life Events") {
          link.setAttribute("href", "https://patricia-lanning.webflow.io/life-events");
          console.log("Updated Life Events link");
        } else if (text === "Recipes") {
          link.setAttribute("href", "https://patricia-lanning.webflow.io/recipes");
          console.log("Updated Recipes link");
        }
      });
    };
    updateLinks();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {});
}
...
export { $$Main as $, Block as B, DevLinkProvider as D, Footer as F, Grid as G, Heading as H, Image as I, Link as L, NavigationWrapper as N, Paragraph as P, Section as S, baseUrl as b, jsxRuntimeExports as j };
