...
const memoriesTable = sqliteTable("memories", {
  ...
  // Optional date (YYYY-MM format)
  location: text("location"),
  // Optional location
  mediaKey: text("media_key"),
  // R2 storage key for photo/video
...
const likesTable = sqliteTable("likes", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  memoryId: text("memory_id").notNull().references(() => memoriesTable.id, { onDelete: "cascade" }),
  createdAt: text("created_at").notNull()
});
const guestbookTable = sqliteTable("guestbook", {
  id: text("id").primaryKey(),
  name: text("name").notNull(),
  email: text("email").notNull(),
  location: text("location"),
...
export { guestbookTable as a, desc as d, eq as e, getDb as g, likesTable as l, memoriesTable as m, sql as s };
