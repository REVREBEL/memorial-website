 ...
 * @param webflowContent - Optional KV cache
 * @param locals - Optional locals with KV
...
export const getComponentMetadata = async (
  ...
  const components = await fetchComponents(webflowClient, siteId, webflowContent, locals);
